...
int checkDistance()
{
	...
	if(distance < dichtbij && distance > heelDichtbij)						//compares if distance is less than 20 cm & bigger than 10 cm
	{
		clear();
	...
	else if(distance < heelDichtbij && distance > 0)						//compares if distance is less than 10 cm 
	{
		clear();
